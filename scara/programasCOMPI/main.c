...
"            for (int g = -350; g <= 350; g += 50) {\n"
"                int ax,ay,bx,by;\n"
"                proj_top(g,-350,0,&ax,&ay);\n"
"                proj_top(g, 350,0,&bx,&by);\n"
"                SDL_RenderDrawLine(ren,ax,ay,bx,by);\n"
"                proj_top(-350,g,0,&ax,&ay);\n"
"                proj_top( 350,g,0,&bx,&by);\n"
"                SDL_RenderDrawLine(ren,ax,ay,bx,by);\n"
"            }\n"
"            int ox,oy;\n"
"            proj_top(0,0,0,&ox,&oy);\n"
"            SDL_SetRenderDrawColor(ren, 60, 60, 30, 255);\n"
"            draw_arc(ren, ox, oy,  50, 75, 100);\n"
"            draw_arc(ren, ox, oy, 350, 75, 100);\n"
"            int ax2,ay2,bx2,by2;\n"
"            proj_top(350,0,0,&ax2,&ay2); proj_top(-350,0,0,&bx2,&by2);\n"
"            SDL_SetRenderDrawColor(ren, 80, 40, 40, 255);\n"
"            SDL_RenderDrawLine(ren,ax2,ay2,bx2,by2);\n"
"            proj_top(0,350,0,&ax2,&ay2); proj_top(0,-350,0,&bx2,&by2);\n"
"            SDL_SetRenderDrawColor(ren, 40, 80, 40, 255);\n"
"            SDL_RenderDrawLine(ren,ax2,ay2,bx2,by2);\n"
"        } else {\n"
"            for (int g = 0; g <= 350; g += 50) {\n"
"                int ax,ay,bx,by;\n"
"                proj_lado(g,0,  0,&ax,&ay);\n"
"                proj_lado(g,0,350,&bx,&by);\n"
"                SDL_RenderDrawLine(ren,ax,ay,bx,by);\n"
"                proj_lado(  0,0,g,&ax,&ay);\n"
"                proj_lado(350,0,g,&bx,&by);\n"
"                SDL_RenderDrawLine(ren,ax,ay,bx,by);\n"
"            }\n"
"            int ax3,ay3,bx3,by3;\n"
"            proj_lado(0,0,0,&ax3,&ay3); proj_lado(350,0,0,&bx3,&by3);\n"
